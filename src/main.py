from src.Modules.test_candidatos import *
from src.Modules.test_comunicacion import *
from src.Modules.test_organizacion import *
from src.Modules.test_redElekta import *
